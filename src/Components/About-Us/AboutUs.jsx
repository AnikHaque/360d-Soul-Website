          ...
          <div class="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
            ...
            <div class="flex flex-col items-start xl:px-16">
              ...
              <a
                href="#"
                title=""
                class="inline-flex items-center justify-center px-5 py-4 text-base font-semibold text-white transition-all duration-200 rounded-md hover:opacity-90 focus:opacity-90 lg:mt-auto bg-[#498db0]"
                role="button"
              >
                Learn About Us
                <svg
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-3 sm:gap-12">
            <div>
              ...
              <h3 class="mt-8 text-2xl font-semibold text-black">Our Vision</h3>
            ...
            <div>
              ...
              <p class="mt-4 text-sm text-gray-600 text-justify">
                ...
                businesses to thrive in today's ever-evolving landscape.
              </p>
            </div>
            ...
            <div>
              ...
              <h3 class="mt-8 text-2xl font-semibold text-black">Our Values</h3>
              <p class="mt-4 text-sm text-gray-600 text-justify">
