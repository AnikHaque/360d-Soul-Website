          ...
          <div className="grid items-stretch gap-y-10 md:grid-cols-2 md:gap-x-20">
            <div className="relative grid grid-cols-2 gap-6 mt-10 md:mt-0">
              <div className="overflow-hidden aspect-w-3 aspect-h-4">
                <img
                  ...
                  src="https://360dsoul.com/wp-content/uploads/elementor/thumbs/close-up-businessman-writing-summary-scaled-qn1qizpch542va2wuu5tmbfntqzww0rdqb4ora39x0.jpg"
                  alt=""
                />
              </div>
            ...
            <div className="flex flex-col items-start xl:px-16">
              ...
              <p className="mt-4 text-base leading-relaxed text-gray-600 text-justify">
                ...
                businesses worldwide. With a passionate team of experts, we
                offer strategic business development solutions tailored to
                unlock potential, drive success and foster enduring
                partnerships.
              </p>
              <p className="text-base leading-relaxed text-gray-600 text-justify">
                ...
                craft tailored solutions to elevate your business to a new
              ...
              <a
                href="#"
                title=""
                className="inline-flex items-center justify-center px-5 py-4 text-base font-semibold text-white transition-all duration-200 rounded-md hover:opacity-90 focus:opacity-90 lg:mt-auto bg-[#498db0]"
                role="button"
              >
                Learn About Us
                <svg
          ...
          <div className="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-3 sm:gap-12">
            <div>
              ...
              <p className="mt-4 text-sm text-gray-600 text-justify">
                360D Soul Ltd. is to be the premier Sourcing & Organizational
                Development (OD) platform, setting the standard for excellence
                in our industry worldwide. We aspire to empower organizations
                with cutting-edge solutions that optimize their resources and
                foster organizational development, driving success and
            ...
            <div>
              ...
              <p className="mt-4 text-sm text-gray-600 text-justify">
                ...
                global footprint. We are committed to long-term sustainability,
                ensuring that our innovative platforms and services empower
                businesses to thrive in todays ever-evolving landscape.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-sm text-gray-600 text-justify">
                360D Soul Ltd. offers comprehensive, cost-effective solutions
                for businesses of all types, from established enterprises to
                emerging startups. Our commitment to ethical and socially
                responsible practices ensures that our services not only boost
                profitability but also contribute positively to society. We
                empower companies to grow sustainably and make a meaningful
                impact on the world
              </p>
            </div>
          </div>
