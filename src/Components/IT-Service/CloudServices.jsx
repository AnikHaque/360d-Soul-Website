const CloudServices = () => {
  return (
    <div>
      ...
      <section className="py-10 bg-[#ecf2fa] sm:py-16 lg:py-24">
          ...
          <div className="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
            <div>
              ...
              <p className="mt-4 text-base text-gray-600">
                Smoothly transition your existing infrastructure to the cloud
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-600">
                Integrate cloud solutions with your current systems for optimal
                performance.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-600">
                Ongoing support and management to keep your cloud infrastructure
                running efficiently.
              </p>
            </div>
          </div>
