const TalentManagement = () => {
  return (
    <div>
      <h2 className="text-3xl font-normal leading-tight text-black sm:text-4xl lg:text-5xl text-center">
        Talent Management
      </h2>
          ...
          <div className="flex flex-col justify-between p-5 border-b sm:p-10 lg:border-b-0 lg:border-r lg:w-1/2">
            <div>
              ...
              <p className="mb-6 text-base text-gray-700 md:text-lg sm:mb-8 text-justify">
                ...
                planning, and succession planning to ensure continuous growth
